...
from .views import (
    ...
    VideoCourseRetrieveUpdateDestroyAPIView,
...
urlpatterns = [
    ...
    path('videos/', VideoCourseAPIView.as_view(), name='videos_detail'),
    path('videos/<int:pk>/', VideoCourseRetrieveUpdateDestroyAPIView.as_view(), name='videos_detail'),
